...
def main():
    ...
    def button1_pressed():
        ...
        mqttc.publish("myhome10234531/light/living_room", "TOGGLE", 0, False)
    ...
    def on_connect(client, userdata, flags, rc):
        ...
        mqttc.subscribe("myhome10234531/light/living_room")
    ...
    def on_message(client, userdata, msg):
        ...
        if msg.topic == "myhome10234531/light/living_room" and msg.payload == b'TOGGLE':
            led1.toggle()
    ...
    mqttc = mqtt.Client("myhome10234531_C1")
